...
<script type="text/javascript">
	$(function(){
		$("#arduinoOn").click() {
			...
			$.get("http://192.168.0.1:80/", {pin:1}); // execute get request
			$.get("http://192.168.4.1:80/", {pin:1}); // execute get request
		}
		$("#arduinoOff").click() {
			$.get("http://192.168.0.15:80/", {pin:0}); // execute get request
			$.get("http://192.168.0.1:80/", {pin:0}); // execute get request
			$.get("http://192.168.4.1:80/", {pin:0}); // execute get request
		}
	})
